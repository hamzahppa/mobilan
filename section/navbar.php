<nav class="navbar navbar-dark bg-inverse bg-inverse-custom navbar-fixed-top">
  <div class="container">
    <a class="navbar-brand" href="#">
      ...
      <img src="img/favicon/apple-icon-57x57.png" alt="Mobilan Logo" class="img-responsive">
      <span class="sr-only">Mobilan Indonesia</span>
    </a>
    ...
    <div id="collapsingNavbar" class="collapse navbar-toggleable-custom" role="tabpanel" aria-labelledby="collapsingNavbar">
      <ul class="nav navbar-nav pull-xs-right">
        <li class="nav-item nav-item-toggable">
          <a class="nav-link" href="#section-text">Adser <span class="sr-only">(current)</span></a>
        </li>
        <li class="nav-item nav-item-toggable active">
          <a class="nav-link" href="mober/">Jadi Mober?</a>
        </li>
        <li class="nav-item nav-item-toggable">
